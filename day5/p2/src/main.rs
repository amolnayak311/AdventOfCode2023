// Naive solution took hours, follwing solution from https://github.com/timvisee/advent-of-code-2023/blob/master/day05b/src/main.rs
// runs in milliseconds and is very elegant
